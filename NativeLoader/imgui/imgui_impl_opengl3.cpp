...
void    ImGui_ImplOpenGL3_RenderDrawData(void* g_hWnd)
{
    RECT rect;
    ::GetClientRect((HWND)g_hWnd, &rect);
    ...
    ImGui_ImplOpenGL3_SetupRenderState(NULL, fb_width, fb_height, vertex_array_object);
...
{
    strcpy(g_GlslVersionString, "#version 130\n");
